...
export default function Services() {
  ...
  const services = [
    {
      ...
      title: "ERP Systems",
      description:
        "Complete enterprise resource planning solutions to streamline business processes.",
      features: [
    ...
    },
    {
      ...
      description:
        "Leverage the power of AI to automate tasks and gain valuable insights.",
      features: [
    ...
    },
    {
      ...
      description:
        "Educational platforms and LMS tailored to your training needs.",
      features: [
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Services Grid */}
      <AnimatedSection className="py-24 relative overflow-hidden bg-gradient-to-b from-background to-muted/20">
                  ...
                  <div className="p-6 pt-0 mt-auto relative z-10">
                    <Link href="/contact">
                      <motion.div
                        ...
                        whileTap={{ scale: 0.98 }}
                      >
                        <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl hover:shadow-primary/40 transition-all duration-300 py-3">
                          Get a Quote
      ...
      {/* Industries Section */}
      <AnimatedSection className="py-24 relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/90">
            ...
            {[
              {
                ...
                desc: "Patient portals, clinic management & health data systems",
              },
              {
                name: "Finance & Fintech",
                icon: <DollarSign className="h-10 w-10" />,
                desc: "Wallets, payment gateways & financial dashboards",
              },
              {
                name: "E-commerce",
                icon: <ShoppingCart className="h-10 w-10" />,
                desc: "Online stores, inventory & recommendation engines",
              },
              {
                name: "Education",
                icon: <GraduationCap className="h-10 w-10" />,
                desc: "LMS platforms, e-learning & student tracking systems",
              },
              {
                name: "Real Estate",
                icon: <Building2 className="h-10 w-10" />,
                desc: "Property listings, CRM & management platforms",
              },
              {
                name: "Logistics",
                icon: <Truck className="h-10 w-10" />,
                desc: "Fleet tracking, supply chain & delivery management",
              },
            ].map((industry, i) => (
              <motion.div
                key={i}
